...
const flavors: Record<string, string[]> = {
  'Base': [
    'Algodón de Azúcar', 'Base Neutra', 'Base Cristal', 'Coco',
    'Chocolate Blanco', 'Chocolate Tradicional', 'Taro', 'Taro/Coco', 'Matcha Latte',
  ],
  'Base Frappé': [
    'Frappé Café', 'Frappé Avellana', 'Frappé Caramelo', 'Frappé Horchata',
    'Frappé Mazapán', 'Frappé Moka', 'Frappé Cookies & Cream', 'Frappé Vainilla Francesa',
  ],
  'Chai Especialidad': [
    'Caramelo', 'Cúrcuma', 'Especias', 'Frutos Rojos',
    'Guayaba', 'Manzana Canela', 'Pumpkin Spice', 'Vainilla Verde',
  ],
  'Malteadas': [
...
function MexicoMap() {
  ...
  fetch(GEO_URL)
    ...
    .then((topology) => {
      ...
      // Tomar el primer objeto del topojson
